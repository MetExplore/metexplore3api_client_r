#' Create a new ReactionsResponse
#'
#' @description
#' ReactionsResponse Class
#'
#' @docType class
#' @title ReactionsResponse
#' @description ReactionsResponse Class
...
ReactionsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return ReactionsResponse in JSON format
    toJSON = function() {
      ReactionsResponseObject <- list()
      if (!is.null(self$`message`)) {
        ReactionsResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        ReactionsResponseObject[["success"]] <-
          self$`success`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ReactionsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ReactionsResponse
...
',
    ...
    #' @description
    #' Validate JSON input with respect to ReactionsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ReactionsResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ReactionsResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ReactionsResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ReactionsResponse
    toString = function() {
      self$toJSONString()
    },
...
# ReactionsResponse$unlock()
#
## Below is an example to define the print function
# ReactionsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ReactionsResponse$lock()
