#' Create a new ProteinResponse
#'
#' @description
#' ProteinResponse Class
#'
#' @docType class
#' @title ProteinResponse
#' @description ProteinResponse Class
...
#' @field result  \link{Protein} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProteinResponse <- R6::R6Class(
  "ProteinResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new ProteinResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ProteinResponse in JSON format
    toJSON = function() {
      ProteinResponseObject <- list()
      if (!is.null(self$`message`)) {
        ProteinResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        ProteinResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        ProteinResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        ProteinResponseObject[["result"]] <-
          self$`result`$toJSON()
      }
      ProteinResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of ProteinResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProteinResponse
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`result` <- Protein$new()$fromJSON(jsonlite::toJSON(this_object$`result`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to ProteinResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProteinResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProteinResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProteinResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProteinResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProteinResponse$unlock()
#
## Below is an example to define the print function
# ProteinResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProteinResponse$lock()
