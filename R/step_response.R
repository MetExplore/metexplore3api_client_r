  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`message`)) {
        StepResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        StepResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        StepResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`steps`)) {
        StepResponseObject[["steps"]] <-
          lapply(self$`steps`, function(x) x$toJSON())
      }
      StepResponseObject
    },
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`steps`)) {
          ...
          [%s]
',
          paste(sapply(self$`steps`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox = TRUE, digits = NA)), collapse = ",")
          )
        }
      )
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StepResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StepResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StepResponse: the required field `status` is missing."))
      }
    },
