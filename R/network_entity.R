...
#' @docType class
#' @title NetworkEntity
#' @description NetworkEntity Class
...
NetworkEntity <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new NetworkEntity class.
    #'
    ...
    #' To JSON String
    #'
    #' @return NetworkEntity in JSON format
    toJSON = function() {
      NetworkEntityObject <- list()
      if (!is.null(self$`id`)) {
        NetworkEntityObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        NetworkEntityObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`db_identifier`)) {
        NetworkEntityObject[["db_identifier"]] <-
          self$`db_identifier`
      }
      if (!is.null(self$`id_network`)) {
        NetworkEntityObject[["id_network"]] <-
          self$`id_network`
      }
      NetworkEntityObject
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of NetworkEntity
    #'
    #' @param input_json the JSON input
    #' @return the instance of NetworkEntity
    ...
    #' @description
    #' Validate JSON input with respect to NetworkEntity and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of NetworkEntity
    toString = function() {
      self$toJSONString()
    },
...
# NetworkEntity$unlock()
#
## Below is an example to define the print function
# NetworkEntity$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
