...
#' @description ApiAppResponse Class
...
#' @field app  \link{ApiApp} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ApiAppResponse <- R6::R6Class(
  "ApiAppResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new ApiAppResponse class.
    #'
    ...
    initialize = function(`message`, `success`, `status`, `app` = NULL, ...) {
      if (!missing(`message`)) {
    ...
    #' To JSON String
    #'
    #' @return ApiAppResponse in JSON format
    toJSON = function() {
      ApiAppResponseObject <- list()
      if (!is.null(self$`message`)) {
        ApiAppResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        ApiAppResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        ApiAppResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`app`)) {
        ApiAppResponseObject[["app"]] <-
          self$`app`$toJSON()
      }
      ApiAppResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of ApiAppResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ApiAppResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`app`)) {
        `app_object` <- ApiApp$new()
        `app_object`$fromJSON(jsonlite::toJSON(this_object$`app`, auto_unbox = TRUE, digits = NA))
        self$`app` <- `app_object`
      }
      self
    },
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`app`)) {
          ...
          %s
          ',
          jsonlite::toJSON(self$`app`$toJSON(), auto_unbox = TRUE, digits = NA)
          )
        }
      )
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`app` <- ApiApp$new()$fromJSON(jsonlite::toJSON(this_object$`app`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to ApiAppResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiAppResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiAppResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiAppResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ApiAppResponse
    toString = function() {
      self$toJSONString()
    },
...
# ApiAppResponse$unlock()
#
## Below is an example to define the print function
# ApiAppResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
