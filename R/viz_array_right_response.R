#' Create a new VizArrayRightResponse
#'
#' @description
#' VizArrayRightResponse Class
#'
#' @docType class
#' @title VizArrayRightResponse
#' @description VizArrayRightResponse Class
...
#' @field results Array of Viz rights list(\link{VizRight}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VizArrayRightResponse <- R6::R6Class(
  "VizArrayRightResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    `status` = NULL,
    ...
    #' @description
    #' Initialize a new VizArrayRightResponse class.
    #'
    ...
    #' @param results Array of Viz rights
    ...
    #' To JSON String
    #'
    #' @return VizArrayRightResponse in JSON format
    toJSON = function() {
      VizArrayRightResponseObject <- list()
      if (!is.null(self$`message`)) {
        VizArrayRightResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        VizArrayRightResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        VizArrayRightResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`results`)) {
        VizArrayRightResponseObject[["results"]] <-
          lapply(self$`results`, function(x) x$toJSON())
      }
      VizArrayRightResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of VizArrayRightResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of VizArrayRightResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[VizRight]", loadNamespace("metexplore3api"))
      }
      self
    },
...
',
    ...
    #' @description
    #' Validate JSON input with respect to VizArrayRightResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VizArrayRightResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VizArrayRightResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VizArrayRightResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of VizArrayRightResponse
    toString = function() {
      self$toJSONString()
    },
...
# VizArrayRightResponse$unlock()
#
## Below is an example to define the print function
# VizArrayRightResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VizArrayRightResponse$lock()
