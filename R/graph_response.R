...
#' @docType class
#' @title GraphResponse
#' @description GraphResponse Class
...
#' @field result  \link{GraphResponseAllOfResult} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GraphResponse <- R6::R6Class(
  "GraphResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new GraphResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GraphResponse in JSON format
    toJSON = function() {
      GraphResponseObject <- list()
      if (!is.null(self$`message`)) {
        GraphResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        GraphResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        GraphResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        GraphResponseObject[["result"]] <-
          self$`result`$toJSON()
      }
      GraphResponseObject
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of GraphResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of GraphResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`result`)) {
        `result_object` <- GraphResponseAllOfResult$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`result` <- GraphResponseAllOfResult$new()$fromJSON(jsonlite::toJSON(this_object$`result`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to GraphResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of GraphResponse
    toString = function() {
      self$toJSONString()
    },
...
# GraphResponse$unlock()
#
## Below is an example to define the print function
# GraphResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
