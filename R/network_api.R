...
#' @export
NetworkApi <- R6::R6Class(
  "NetworkApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new NetworkApi.
    #'
    ...
    #' delete a Metabolic Network
    #'
    #' @param delnetwork_request (optional) No description
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    #' @return BaseResponse
    DELNETWORK = function(delnetwork_request = NULL, data_file = NULL, ...) {
      local_var_response <- self$DELNETWORKWithHttpInfo(delnetwork_request, data_file = data_file, ...)
    ...
    DELNETWORKWithHttpInfo = function(delnetwork_request = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`delnetwork_request`)) {
        local_var_body <- `delnetwork_request`$toJSONString()
      } else {
        body <- NULL
      }
