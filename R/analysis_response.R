...
#' @description AnalysisResponse Class
...
#' @field analysis  \link{Analysis} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
AnalysisResponse <- R6::R6Class(
  "AnalysisResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new AnalysisResponse class.
    #'
    ...
    initialize = function(`message`, `success`, `status`, `analysis` = NULL, ...) {
      if (!missing(`message`)) {
    ...
    #' To JSON String
    #'
    #' @return AnalysisResponse in JSON format
    toJSON = function() {
      AnalysisResponseObject <- list()
      if (!is.null(self$`message`)) {
        AnalysisResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        AnalysisResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        AnalysisResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`analysis`)) {
        AnalysisResponseObject[["analysis"]] <-
          self$`analysis`$toJSON()
      }
      AnalysisResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of AnalysisResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AnalysisResponse
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`analysis` <- Analysis$new()$fromJSON(jsonlite::toJSON(this_object$`analysis`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to AnalysisResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysisResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysisResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysisResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AnalysisResponse
    toString = function() {
      self$toJSONString()
    },
...
# AnalysisResponse$unlock()
#
## Below is an example to define the print function
# AnalysisResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AnalysisResponse$lock()
