  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        AppResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        AppResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`app`)) {
        AppResponseObject[["app"]] <-
          self$`app`$toJSON()
      }
      AppResponseObject
    },
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`app` <- App$new()$fromJSON(jsonlite::toJSON(this_object$`app`, auto_unbox = TRUE, digits = NA))
      self
    },
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AppResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AppResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AppResponse: the required field `status` is missing."))
      }
    },
