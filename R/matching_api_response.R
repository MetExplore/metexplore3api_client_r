#' Create a new MatchingApiResponse
#'
#' @description
#' MatchingApiResponse Class
#'
#' @docType class
#' @title MatchingApiResponse
#' @description MatchingApiResponse Class
...
#' @field response  \link{MatchingApiResponseAllOfResponse} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MatchingApiResponse <- R6::R6Class(
  "MatchingApiResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new MatchingApiResponse class.
    #'
    ...
    initialize = function(`message`, `success`, `status`, `response` = NULL, ...) {
      if (!missing(`message`)) {
    ...
    #' To JSON String
    #'
    #' @return MatchingApiResponse in JSON format
    toJSON = function() {
      MatchingApiResponseObject <- list()
      if (!is.null(self$`message`)) {
        MatchingApiResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        MatchingApiResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        MatchingApiResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`response`)) {
        MatchingApiResponseObject[["response"]] <-
          self$`response`$toJSON()
      }
      MatchingApiResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of MatchingApiResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of MatchingApiResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`response`)) {
        `response_object` <- MatchingApiResponseAllOfResponse$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`response` <- MatchingApiResponseAllOfResponse$new()$fromJSON(jsonlite::toJSON(this_object$`response`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to MatchingApiResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MatchingApiResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MatchingApiResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MatchingApiResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MatchingApiResponse
    toString = function() {
      self$toJSONString()
    },
...
# MatchingApiResponse$unlock()
#
## Below is an example to define the print function
# MatchingApiResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MatchingApiResponse$lock()
