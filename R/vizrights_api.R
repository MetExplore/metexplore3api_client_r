...
#'
#' @docType class
#' @title Vizrights operations
#' @description VizrightsApi
...
#' @export
VizrightsApi <- R6::R6Class(
  "VizrightsApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new VizrightsApi.
    #'
    ...
    GETVIZRIGHTS = function(id, data_file = NULL, ...) {
      local_var_response <- self$GETVIZRIGHTSWithHttpInfo(id, data_file = data_file, ...)
    ...
    #' @param ... Other optional arguments
    #'
    #' @return API response (VizArrayRightResponse) with additional information such as HTTP status code, headers
    GETVIZRIGHTSWithHttpInfo = function(id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "VizArrayRightResponse", loadNamespace("metexplore3api")),
          error = function(e) {
