...
#' @description ExportResponse Class
...
ExportResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ExportResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ExportResponse in JSON format
    toJSON = function() {
      ExportResponseObject <- list()
      if (!is.null(self$`message`)) {
        ExportResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        ExportResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        ExportResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        ExportResponseObject[["result"]] <-
          self$`result`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ExportResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ExportResponse
    ...
    #' @description
    #' Validate JSON input with respect to ExportResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ExportResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ExportResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ExportResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ExportResponse
    toString = function() {
      self$toJSONString()
    },
...
# ExportResponse$unlock()
#
## Below is an example to define the print function
# ExportResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
