#' Create a new AnalysesMappingResponse
#'
#' @description
#' AnalysesMappingResponse Class
#'
#' @docType class
#' @title AnalysesMappingResponse
#' @description AnalysesMappingResponse Class
...
#' @field analyses Array of mapping analyses list(\link{AnalysisMapping}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
AnalysesMappingResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AnalysesMappingResponse class.
    #'
    ...
    #' @param analyses Array of mapping analyses
    ...
    #' To JSON String
    #'
    #' @return AnalysesMappingResponse in JSON format
    toJSON = function() {
      AnalysesMappingResponseObject <- list()
      if (!is.null(self$`message`)) {
        AnalysesMappingResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        AnalysesMappingResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        AnalysesMappingResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`analyses`)) {
        AnalysesMappingResponseObject[["analyses"]] <-
          lapply(self$`analyses`, function(x) x$toJSON())
      }
      AnalysesMappingResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of AnalysesMappingResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AnalysesMappingResponse
...
',
    ...
    #' @description
    #' Validate JSON input with respect to AnalysesMappingResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysesMappingResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysesMappingResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnalysesMappingResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AnalysesMappingResponse
    toString = function() {
      self$toJSONString()
    },
...
# AnalysesMappingResponse$unlock()
#
## Below is an example to define the print function
# AnalysesMappingResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AnalysesMappingResponse$lock()
