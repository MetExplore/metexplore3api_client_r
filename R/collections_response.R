...
#' @field collections Array of Metabolic Network Collections list(\link{Collection}) [optional]
...
CollectionsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param collections Array of Metabolic Network Collections
    #' @param ... Other optional arguments.
    initialize = function(`message`, `success`, `status`, `collections` = NULL, ...) {
      if (!missing(`message`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`message`)) {
        CollectionsResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        CollectionsResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        CollectionsResponseObject[["status"]] <-
          self$`status`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`collections`)) {
        self$`collections` <- ApiClient$new()$deserializeObj(this_object$`collections`, "array[Collection]", loadNamespace("metexplore3api"))
      }
      self
    },
...
',
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CollectionsResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CollectionsResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CollectionsResponse: the required field `status` is missing."))
      }
    },
