#' Create a new CompartmentsResponse
#'
#' @description
#' CompartmentsResponse Class
#'
#' @docType class
#' @title CompartmentsResponse
#' @description CompartmentsResponse Class
...
#' @field results Array of Compartments list(\link{Compartment}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CompartmentsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CompartmentsResponse class.
    #'
    ...
    #' @param results Array of Compartments
    ...
    #' To JSON String
    #'
    #' @return CompartmentsResponse in JSON format
    toJSON = function() {
      CompartmentsResponseObject <- list()
      if (!is.null(self$`message`)) {
        CompartmentsResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        CompartmentsResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        CompartmentsResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`results`)) {
        CompartmentsResponseObject[["results"]] <-
          lapply(self$`results`, function(x) x$toJSON())
      }
      CompartmentsResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of CompartmentsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of CompartmentsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[Compartment]", loadNamespace("metexplore3api?"))
      }
      self
    },
...
',
    ...
    #' @description
    #' Validate JSON input with respect to CompartmentsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentsResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentsResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentsResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CompartmentsResponse
    toString = function() {
      self$toJSONString()
    },
...
# CompartmentsResponse$unlock()
#
## Below is an example to define the print function
# CompartmentsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CompartmentsResponse$lock()
