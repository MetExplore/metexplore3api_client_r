#' Create a new MetabolitesResponse
#'
#' @description
#' MetabolitesResponse Class
#'
#' @docType class
#' @title MetabolitesResponse
#' @description MetabolitesResponse Class
...
#' @field metabolites Array of Metabolite list(\link{Metabolite}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MetabolitesResponse <- R6::R6Class(
  "MetabolitesResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new MetabolitesResponse class.
    #'
    ...
    #' @param metabolites Array of Metabolite
    #' @param ... Other optional arguments.
    initialize = function(`message`, `success`, `status`, `metabolites` = NULL, ...) {
      if (!missing(`message`)) {
      ...
      if (!is.null(`metabolites`)) {
        stopifnot(is.vector(`metabolites`), length(`metabolites`) != 0)
        sapply(`metabolites`, function(x) stopifnot(R6::is.R6(x)))
    ...
    #' To JSON String
    #'
    #' @return MetabolitesResponse in JSON format
    toJSON = function() {
      MetabolitesResponseObject <- list()
      if (!is.null(self$`message`)) {
        MetabolitesResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        MetabolitesResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        MetabolitesResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`metabolites`)) {
        MetabolitesResponseObject[["metabolites"]] <-
          lapply(self$`metabolites`, function(x) x$toJSON())
      }
      MetabolitesResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of MetabolitesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of MetabolitesResponse
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`metabolites`)) {
          ...
          [%s]
',
          paste(sapply(self$`metabolites`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox = TRUE, digits = NA)), collapse = ",")
          )
        }
      )
    ...
    #' @description
    #' Validate JSON input with respect to MetabolitesResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MetabolitesResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MetabolitesResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MetabolitesResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MetabolitesResponse
    toString = function() {
      self$toJSONString()
    },
...
# MetabolitesResponse$unlock()
#
## Below is an example to define the print function
# MetabolitesResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MetabolitesResponse$lock()
