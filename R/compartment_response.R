#' Create a new CompartmentResponse
#'
#' @description
#' CompartmentResponse Class
#'
#' @docType class
#' @title CompartmentResponse
#' @description CompartmentResponse Class
...
#' @field result  \link{Compartment} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CompartmentResponse <- R6::R6Class(
  "CompartmentResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new CompartmentResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return CompartmentResponse in JSON format
    toJSON = function() {
      CompartmentResponseObject <- list()
      if (!is.null(self$`message`)) {
        CompartmentResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        CompartmentResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        CompartmentResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        CompartmentResponseObject[["result"]] <-
          self$`result`$toJSON()
      }
      CompartmentResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of CompartmentResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of CompartmentResponse
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`result` <- Compartment$new()$fromJSON(jsonlite::toJSON(this_object$`result`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to CompartmentResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CompartmentResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CompartmentResponse
    toString = function() {
      self$toJSONString()
    },
...
# CompartmentResponse$unlock()
#
## Below is an example to define the print function
# CompartmentResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CompartmentResponse$lock()
