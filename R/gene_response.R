...
#' @docType class
#' @title GeneResponse
#' @description GeneResponse Class
...
#' @field result  \link{Gene} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GeneResponse <- R6::R6Class(
  "GeneResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new GeneResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GeneResponse in JSON format
    toJSON = function() {
      GeneResponseObject <- list()
      if (!is.null(self$`message`)) {
        GeneResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        GeneResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        GeneResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        GeneResponseObject[["result"]] <-
          self$`result`$toJSON()
      }
      GeneResponseObject
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of GeneResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of GeneResponse
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`result` <- Gene$new()$fromJSON(jsonlite::toJSON(this_object$`result`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to GeneResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GeneResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GeneResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GeneResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of GeneResponse
    toString = function() {
      self$toJSONString()
    },
...
# GeneResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
