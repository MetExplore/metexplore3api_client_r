...
CompartmentsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' count number of compartments in a network
    #'
    #' @param id_network the id_network for the compartment
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    #' @return CountResponse
    COUNTCOMPARTMENTS = function(id_network, data_file = NULL, ...) {
      local_var_response <- self$COUNTCOMPARTMENTSWithHttpInfo(id_network, data_file = data_file, ...)
    ...
    COUNTCOMPARTMENTSWithHttpInfo = function(id_network, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/compartments/count"
    ...
    #' Delete a Compartment from a Network
    #'
    #' @param compartment (optional) No description
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    #' @return BaseResponse
    DELCOMPARTMENT = function(compartment = NULL, data_file = NULL, ...) {
      local_var_response <- self$DELCOMPARTMENTWithHttpInfo(compartment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    DELCOMPARTMENTWithHttpInfo = function(compartment = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`compartment`)) {
        body.items <- paste(unlist(lapply(`compartment`, function(param) {
                                                             param$toJSONString()
                                                         })), collapse = ",")
    ...
    POSTCOMPARTMENT = function(compartment = NULL, data_file = NULL, ...) {
      local_var_response <- self$POSTCOMPARTMENTWithHttpInfo(compartment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param ... Other optional arguments
    #'
    #' @return API response (CompartmentResponse) with additional information such as HTTP status code, headers
    POSTCOMPARTMENTWithHttpInfo = function(compartment = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`compartment`)) {
        local_var_body <- `compartment`$toJSONString()
      } else {
        body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "CompartmentResponse", loadNamespace("metexplore3api?")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return BaseResponse
    UPDATECOMPARTMENT = function(compartment = NULL, data_file = NULL, ...) {
      local_var_response <- self$UPDATECOMPARTMENTWithHttpInfo(compartment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (BaseResponse) with additional information such as HTTP status code, headers
    UPDATECOMPARTMENTWithHttpInfo = function(compartment = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
