#' Create a new PathwayResponse
#'
#' @description
#' PathwayResponse Class
#'
#' @docType class
#' @title PathwayResponse
#' @description PathwayResponse Class
...
#' @field result  \link{Pathway} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PathwayResponse <- R6::R6Class(
  "PathwayResponse",
  public = list(
    `message` = NULL,
    `success` = NULL,
    ...
    #' @description
    #' Initialize a new PathwayResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PathwayResponse in JSON format
    toJSON = function() {
      PathwayResponseObject <- list()
      if (!is.null(self$`message`)) {
        PathwayResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        PathwayResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        PathwayResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`result`)) {
        PathwayResponseObject[["result"]] <-
          self$`result`$toJSON()
      }
      PathwayResponseObject
    },

    #' @description
    #' Deserialize JSON string into an instance of PathwayResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PathwayResponse
    ...
    fromJSONString = function(input_json) {
      ...
      self$`success` <- this_object$`success`
      self$`status` <- this_object$`status`
      self$`result` <- Pathway$new()$fromJSON(jsonlite::toJSON(this_object$`result`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to PathwayResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PathwayResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PathwayResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PathwayResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PathwayResponse
    toString = function() {
      self$toJSONString()
    },
...
# PathwayResponse$unlock()
#
## Below is an example to define the print function
# PathwayResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PathwayResponse$lock()
