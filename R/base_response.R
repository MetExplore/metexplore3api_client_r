...
#' @docType class
#' @title BaseResponse
#' @description BaseResponse Class
...
BaseResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BaseResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return BaseResponse in JSON format
    toJSON = function() {
      BaseResponseObject <- list()
      if (!is.null(self$`message`)) {
        BaseResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`success`)) {
        BaseResponseObject[["success"]] <-
          self$`success`
      }
      if (!is.null(self$`status`)) {
        BaseResponseObject[["status"]] <-
          self$`status`
      }
      BaseResponseObject
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of BaseResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of BaseResponse
    ...
    #' @description
    #' Validate JSON input with respect to BaseResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BaseResponse: the required field `message` is missing."))
      }
      ...
      if (!is.null(input_json$`success`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BaseResponse: the required field `success` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BaseResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BaseResponse
    toString = function() {
      self$toJSONString()
    },
...
# BaseResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
