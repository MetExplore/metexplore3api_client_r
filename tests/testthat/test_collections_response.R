...
context("Test CollectionsResponse")

model_instance <- CollectionsResponse$new()
...
test_that("collections", {
  # tests for the property `collections` (array[Collection])
  # Array of Metabolic Network Collections
