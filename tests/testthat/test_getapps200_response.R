...
context("Test GETAPPS200Response")

model_instance <- GETAPPS200Response$new()
...
test_that("apps", {
  # tests for the property `apps` (array[App])
  # Array of MetExplore apps

  # uncomment below to test the property
  #expect_equal(model.instance$`apps`, "EXPECTED_RESULT")
})

test_that("app", {
  # tests for the property `app` (App)
